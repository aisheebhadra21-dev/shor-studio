...
{room && (
  ...
  <span className="font-poppins">listening now</span>
</div>
      ...
      <div className="safe-top safe-right fixed z-40 flex items-center gap-1 translate-x-1 sm:gap-2 sm:translate-x-0">
        ...
        >
          <span className="font-poppins">Spotify</span>
        </a>
...
>
  ...
  room
    ...
    : "h-auto w-[min(35vw,330px)] max-sm:w-[min(112vw,360px)] brightness-90 max-sm:brightness-97 drop-shadow-[0_8px_22px_rgba(0,0,0,.5)]"
}
  />
</div>
</>
